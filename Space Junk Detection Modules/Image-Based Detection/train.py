...
from model import UzayCopuAlgilayici
from veri_seti import UzayCopuVeriSeti, egitim_donusumu_olustur, dogrulama_donusumu_olustur
from kayip import UzayCopuKayipFonksiyonu
...
def veri_yukleyici_olustur(veri_yolu, donusum, karistir=True):
    veri_seti = UzayCopuVeriSeti(veri_yolu, donusum=donusum)
...
def egitimi_baslat():
    ...
    model = UzayCopuAlgilayici().to(cihaz)
    ...
    kayip_fonksiyonu = UzayCopuKayipFonksiyonu().to(cihaz)
