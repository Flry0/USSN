...
def veri_topla_ve_isle(gun_sayisi=None, yorunge_zenginlestir=False):
    ...
    print("=" * 60)
    print("  UZAY_COPU CARPMA TAHMINI - VERI TOPLAMA")
    print("=" * 60)

    ham_veri = toplu_veri_topla(gun_sayisi=gun_sayisi)

    if yorunge_zenginlestir and ham_veri.get("neows_uzay_copuler"):
        print("\n[*] Yorunge verileri zenginlestiriliyor...")
        ham_veri["neows_uzay_copuler"] = yorunge_verileri_zenginlestir(
            ham_veri["neows_uzay_copuler"]
        )
